...
// Kutyus helyzete (alsó részre pozicionálva)
let dog = { x: 300, y: 900, width: 120, height: 120, state: "Alap (Idle)", currentImage: dogImages.idle };

// Tálak helyzete (alsó részre pozicionálva)
const bowls = {
